...
public interface Pairing {
     ...
     * <tt>false</tt> otherwise.
     * @since 2.0.0
     * @see #pairing(it.unisa.dia.gas.jpbc.Element[], it.unisa.dia.gas.jpbc.Element[])
     */
     ...
     * @see #getPairingPreProcessingFromElement(it.unisa.dia.gas.jpbc.Element)
     * @see it.unisa.dia.gas.jpbc.PairingPreProcessing
     */
