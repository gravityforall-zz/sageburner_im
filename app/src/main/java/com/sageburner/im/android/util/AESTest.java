...
public class AESTest
    ...
    private void test(
        ...
        System.out.println("Encrypt Success! bytes: " + new String(Hex.encode(bytes)) + ", output: " + new String(Hex.encode(output)));
        ...
        System.out.println("Decrypt Success! bytes: " + new String(Hex.encode(bytes)) + ", input: " + new String(Hex.encode(input)));
    }
